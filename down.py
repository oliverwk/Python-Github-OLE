...
def run_process(url, output_path):
    ...
    os.rename(r'/Users/MWK/Desktop/OLE/tatiana/91018230_151840196296351_1894637158564459764_n{n}.jpg',r'/Users/MWK/Desktop/OLE/tatiana/tatiana_art_{n}.jpg' .format(n=name))
...
if __name__ == '__main__':
    ...
    for url, path in download_list: # change here to download other files
        ...
        #read = urlopen(description["content"]).geturl()
        #print(read)
